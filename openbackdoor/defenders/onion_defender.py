...
class ONIONDefender(Defender):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.frr = frr
        self.poison_dataset = data_name
        self.attacker = attack_name
...
class GPT2LM():
    def __init__(self, parallel):
        ...
        self.tokenizer = transformers.GPT2TokenizerFast.from_pretrained("./victim_models/gpt2")
        self.lm = transformers.GPT2LMHeadModel.from_pretrained("./victim_models/gpt2").to(self.device)
        if parallel:
